...
func setupModelListControllerTestDB(t *testing.T) *gorm.DB {
	...
	savedFallbackConfig := map[string]string{}
	require.NoError(t, config.GlobalConfig.SaveToDB(func(key, value string) error {
		if strings.HasPrefix(key, "fallback_model_setting.") {
			savedFallbackConfig[key] = value
		}
		return nil
	}))
	require.NoError(t, config.GlobalConfig.LoadFromDB(map[string]string{
		"fallback_model_setting.models": "[]",
	}))
	...
	t.Cleanup(func() {
		...
		require.NoError(t, config.GlobalConfig.LoadFromDB(savedFallbackConfig))
	})
...
func withFallbackModelSettingsForController(t *testing.T, settings model_setting.FallbackModelSettings) {
	t.Helper()
...
func TestGetUserModelsIncludesFallbackModelsForRequestedGroup(t *testing.T) {
	db := setupModelListControllerTestDB(t)
	withFallbackModelSettingsForController(t, model_setting.FallbackModelSettings{
		Models: []model_setting.FallbackModel{
			{Name: "zz-auto-default", Enabled: true, Groups: []string{"default"}, Attempts: []model_setting.FallbackModelAttempt{{ChannelID: 1, Model: "upstream-a"}}},
			{Name: "zz-auto-vip", Enabled: true, Groups: []string{"vip"}, Attempts: []model_setting.FallbackModelAttempt{{ChannelID: 2, Model: "upstream-b"}}},
		},
	})
	require.NoError(t, db.Create(&model.User{
		Id:       1003,
		Username: "fallback-model-list-user",
		Password: "password",
		Group:    "default",
		Status:   common.UserStatusEnabled,
	}).Error)
	require.NoError(t, db.Create(&model.Ability{
		Group:     "default",
		Model:     "zz-default-channel-model",
		ChannelId: 1,
		Enabled:   true,
	}).Error)
	...
	require.ElementsMatch(t, []string{"zz-default-channel-model", "zz-auto-default"}, decodeUserModelsResponse(t, recorder))
}

func TestListModelsIncludesVisibleFallbackModels(t *testing.T) {
	withSelfUseModeDisabled(t)
	withTieredBillingConfig(t, map[string]string{
		"zz-auto-default": "tiered_expr",
		"zz-auto-vip":     "tiered_expr",
	}, map[string]string{
		"zz-auto-default": `tier("base", p + c)`,
		"zz-auto-vip":     `tier("base", p + c)`,
	})
	db := setupModelListControllerTestDB(t)
	withFallbackModelSettingsForController(t, model_setting.FallbackModelSettings{
		Models: []model_setting.FallbackModel{
			{Name: "zz-auto-default", Enabled: true, Groups: []string{"default"}, Attempts: []model_setting.FallbackModelAttempt{{ChannelID: 1, Model: "upstream-a"}}},
			{Name: "zz-auto-vip", Enabled: true, Groups: []string{"vip"}, Attempts: []model_setting.FallbackModelAttempt{{ChannelID: 2, Model: "upstream-b"}}},
			{Name: "zz-auto-disabled", Enabled: false, Groups: []string{"default"}, Attempts: []model_setting.FallbackModelAttempt{{ChannelID: 3, Model: "upstream-c"}}},
		},
	})
	require.NoError(t, db.Create(&model.User{
		Id:       1004,
		Username: "fallback-relay-model-list-user",
		Password: "password",
		Group:    "default",
		Status:   common.UserStatusEnabled,
	}).Error)
	...
	require.Contains(t, ids, "zz-auto-default")
	require.NotContains(t, ids, "zz-auto-vip")
	require.NotContains(t, ids, "zz-auto-disabled")
}

func TestListModelsTokenLimitIncludesAllowedFallbackModel(t *testing.T) {
	withSelfUseModeDisabled(t)
	withTieredBillingConfig(t, map[string]string{
		"zz-token-auto": "tiered_expr",
	}, map[string]string{
		"zz-token-auto": `tier("base", p + c)`,
	})
	setupModelListControllerTestDB(t)
	withFallbackModelSettingsForController(t, model_setting.FallbackModelSettings{
		Models: []model_setting.FallbackModel{
			{Name: "zz-token-auto", Enabled: true, Groups: []string{"default"}, Attempts: []model_setting.FallbackModelAttempt{{ChannelID: 1, Model: "upstream-a"}}},
		},
	})
	...
	require.Contains(t, decodeListModelsResponse(t, recorder), "zz-token-auto")
}
